...
if($_POST){
    ...
    $sentencia = $conexion->prepare("INSERT INTO `tbl_cocineros` 
    ...
    <div class="card-body">
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="descripcion" class="form-control" name="descripcion" id="descripcion" aria-describedby="helpId" placeholder=""/>
            </div>
            ...
            <button type="submit" class="btn btn-success">Agregar cocineros</button>
