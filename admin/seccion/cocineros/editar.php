...
if($_POST){
    ...
    $sentencia = $conexion->prepare("UPDATE `tbl_cocineros` 
    SET 
    titulo=:titulo, 
    ...
    if($foto!=""){
        ...
        move_uploaded_file($tmp_foto,"../../../images/cocineros/".$nombre_foto);
...
<br/>
<div class="card">
    <div class="card-header">Cocineros</div>
    <div class="card-body">
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <img width="90" src="../../../images/cocineros/<?php echo $foto;?>" />
            ...
            <button type="submit" class="btn btn-success">Modificar cocinero</button>
